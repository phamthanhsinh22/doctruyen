...
<div class="box-container"> <div class="card-box"> 
	...
	<div class="register-main"> 
		<form method="post" action="{{URL('forget-password')}}" class="loginForm">
		{{csrf_field()}}
		@if ($errors->any())
